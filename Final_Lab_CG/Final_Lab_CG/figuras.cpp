...
void CFiguras::skybox(float largo, float altura, float profundidad, GLuint text, float ani1)  //Funcion creacion cielo
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);	//Front
			...
			glTexCoord2f(0.0f - ani1, 0.0f); glVertex3fv(vertice[0]);
			glTexCoord2f(0.0f - ani1, 1.0f); glVertex3fv(vertice[4]);
			glTexCoord2f(1.0f - ani1, 1.0f); glVertex3fv(vertice[7]);
			glTexCoord2f(1.0f - ani1, 0.0f); glVertex3fv(vertice[1]);
		glEnd();

		glBegin(GL_POLYGON);	//Right
			glNormal3f( -1.0f, 0.0f, 0.0f);
			glTexCoord2f(0.0f + ani1, 0.0f); glVertex3fv(vertice[0]);
			glTexCoord2f(1.0f + ani1, 0.0f); glVertex3fv(vertice[3]);
			glTexCoord2f(1.0f + ani1, 1.0f); glVertex3fv(vertice[5]);
			glTexCoord2f(0.0f + ani1, 1.0f); glVertex3fv(vertice[4]);
		glEnd();

		glBegin(GL_POLYGON);	//Back
			glNormal3f( 0.0f, 0.0f,1.0f);
			glTexCoord2f(0.0f - ani1, 1.0f); glVertex3fv(vertice[6]);
			glTexCoord2f(1.0f - ani1, 1.0f); glVertex3fv(vertice[5]);
			glTexCoord2f(1.0f - ani1, 0.0f); glVertex3fv(vertice[3]);
			glTexCoord2f(0.0f - ani1, 0.0f); glVertex3fv(vertice[2]);
		glEnd();
...
void CFiguras::prismaEsp1(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
	...
	glTexCoord2f(8.0f, 6.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, 6.0f); glVertex3fv(vertice[4]);
	glEnd();
	...
	glTexCoord2f(8.0f, 6.0f); glVertex3fv(vertice[7]);
	glTexCoord2f(0.0f, 6.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();
...
void CFiguras::prismaEsp2(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prismaEsp3(float altura, float largo, float profundidad, GLuint text1, GLuint text2)  //Funcion creacion prisma
{
